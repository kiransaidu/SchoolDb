...
namespace SchoolDb.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentsRollNo,StudentsName,ClassId,SubjectId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentsRollNo,StudentsName,ClassId,SubjectId")] Student student)
        {
            if (ModelState.IsValid)
            {
